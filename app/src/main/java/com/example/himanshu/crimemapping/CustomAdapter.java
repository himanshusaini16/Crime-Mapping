...
public class CustomAdapter extends ArrayAdapter<String> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            mViewHolder.crime_images = (ImageView) convertView.findViewById(R.id.crime_image_spinner);
            mViewHolder.crime_heading = (TextView) convertView.findViewById(R.id.crime_heading);
            mViewHolder.crime_description = (TextView) convertView.findViewById(R.id.crime_description);
